...
def calculate_risk(symptoms):
    ...
    high_risk = ["chest pain", "breathing difficulty", "snake", "insect bite", "poison", 
                 "pesticide", "accident", "trauma", "maternal", "pregnancy", "stroke", 
                 "severe bleeding", "seizure", "burn", "heart attack", "unconscious", 
                 "allergic reaction", "choking", "cardiac arrest", "aortic dissection", 
                 "aneurysm", "anaphylaxis", "ectopic", "placental abruption", 
                 "eclampsia", "status asthmaticus", "arterial bleeding"]
                 
    medium_risk = ["fever", "body pain", "fracture", "deep cut", "vomiting", 
                   "dehydration", "dizzy", "head trauma", "asthma"]
                   
    low_risk = ["headache", "minor cut", "rash", "stomach ache", "cold", "cough", 
                "sore throat", "nausea"]
